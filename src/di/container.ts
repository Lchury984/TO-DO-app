...
import { FirebaseTodoDataSource } from '../data/datasources/FirebaseTodoDataSource'; // cambiar
import { TodoRepositoryFirebaseImpl } from '../data/repositories/TodoRepositoryFirebaseImpl';  // Cambiar
...
import { UpdateProfile } from "@/src/domain/usecases/UpdateProfile"; // ✅ importa aquí
...
class DIContainer {
  ...
  get updateProfile(): UpdateProfile {
    if (!this._updateProfile) {
      this._updateProfile = new UpdateProfile(this.authRepository); // ✅ usar el getter
    }
